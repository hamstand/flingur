...
.factory('SinglePhoto', function($resource) {
    return $resource('http://flickr.com/services/rest/?method=flickr.photos.getInfo&api_key=237092eefc192e84aa7c30e357ad64bf&photo_id=:photoId&format=json&nojsoncallback=1',{format:'json', jsoncallback: 'JSON_CALLBACK'},  {get: {method: 'JSONP', isArray: false}});
})
